...
public class BuyConnection extends JFrame {
	...
	static long getPhoneNo = UserDashboard.phoneNo;
	Plan selectedPlan;
	...
	public BuyConnection() {
		...
		GradientPanel mainPanel = new GradientPanel("/icons/AdminNvidia.jpg");
	...
	public void handleSubmitButton(JTextField mobileField, JTextField userNameField, JComboBox<String> cityCombo) {
		...
		generateAccountNo();
		query = "insert into broadband_plans" + "\n" + "values('" + phoneNo + "'," + "'" + planType + "'," + "'"
				+ planPrice + "'," + "'" + planData + "'," + "'" + speed + "'," + "'" + planDuration + "'," + "'"
				+ accountNo + "');";
	...
	public JComboBox<String> createStyledComboBox() {
		...
		combo.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY),
	...
	public JTextField addStyledTextFields(String placeholder) {
		...
		textField.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY),
...
class RoundPanel extends JPanel {
    ...
    private int radius = 30; // Changed radius to 30
